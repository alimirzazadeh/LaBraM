...
def main(args):
    ...
    exp_name = exp_name + args.custom_name
...
if __name__ == "__main__":
    ...
    parser.add_argument('--multitaper', action='store_true', default=False)
    ...
    parser.add_argument('--normalize_spec', action='store_true', default=False)
    parser.add_argument('--percentile_low', type=float, default=-20)
    parser.add_argument('--percentile_high', type=float, default=30)
    parser.add_argument('--drop_extra_channels', action='store_true', default=False)
